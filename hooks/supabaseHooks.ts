...
export function useSupabase() {
    ...
    async function testReadingsInsert({ props, id }: { props: testReadingsInsertProps, id?: string }) {
        try {
            ...
            const readingRow = { pool_id: poolId, free_chlorine: props.free_chlorine, total_chlorine: props.total_chlorine, bromine: props.bromine, ph: props.ph, total_alkalinity: props.total_alkalinity, cyanuric_acid: props.cyanuric_acid, total_hardness: props.total_hardness, calcium_hardness: props.calcium_hardness, combined_chlorine: props.combined_chlorine, salt: props.salt, pool_status: props.pool_status, swimming_status: props.swimming_status, }
