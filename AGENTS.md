...
We are building a PoolPal which is a homeowner-first pool-care application that turns pool profile information, water readings, photos, equipment details, and a curated scenario library into calm, step-by-step guidance. mobile app using Expo.

The app help mantain their pools by first completing a pool profile which is based on few questions before going to dashboard. Features may include:

- AI assisted diagnostics
- Photo handlings of the pool for pool profile.
- chat-based AI for asking questions.
- video lessons
- subscriptions
- basic education content
- beautiful mobile-first UI inspired by playful learning apps
- personal pool caring tips base on the pool profile.
...
- it represents a clear UI concept like `PoolCard`, `BAR`, or `PrimaryButton`
...
5. Icons and images are inside assets/icons and assets/graphics
...
Use hardcoded JSON/TS for onboarding questions.
...
supabase database for this version.
